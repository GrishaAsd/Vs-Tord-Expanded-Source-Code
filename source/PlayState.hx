...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'tordstage':
				var bg:BGSprite = new BGSprite('tord/bgnormal', -315, -100, 0.9, 0.9);
				add(bg);
			case 'torddestroyed':
				var bg:BGSprite = new BGSprite('tord/bgdestroyed', -1350, -2780, 0.9, 0.9);
				add(bg);
			case 'tordold':
				var bg:BGSprite = new BGSprite('tord/oldbg', -315, -100, 0.9, 0.9);
				add(bg);
