...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['Mod completed by: '], 45);
				// credTextShit.visible = true;
				case 3:
					addMoreText('Merphi', 45);
					addMoreText('GrishaAsd', 45);
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['Official Version'], -60);
				case 7:
					addMoreText('Press F', -60);
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Tord Expanded'); // credTextShit.text += '\nFunkin';
				case 16:
					skipIntro();
			}
		}
